...
"""
Creates context CSV for loading into Milvus DB.
Args:
    None
Returns:
    None
...
"""
Returns a file path for the given file type, including the current date.
Args:
    file_type (str): The type of file to create a path for.
Returns:
...
"""
Returns a content list from NewsAPI with the given news query list.
Args:
    queries (list): A list of queries to search for.
    domains (list) : A list of domains to search for.
    excludeDomains (list) : A list of domains to exclude from the search.
Returns:
    content (list): A list of lists containing the URL, title, date, and content of each article.
"""
...
"""
Constructs row data from the given news object.
Args:
    n (dict): News object from NewsAPI.
    g (Goose): Goose object for extracting article content.
Returns:
    row_data (list): A list containing the URL, title, date, and content of the article.
"""
def row_data(n, g) :
    title = n.get('title')
